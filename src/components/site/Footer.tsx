      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
          ...
          <div className="grid gap-2 font-mono text-[11px] uppercase tracking-[0.14em] text-muted-foreground">
            ...
            <a href="#pearson" className="transition-colors hover:text-primary">Certifications</a>
            <a href="#why" className="transition-colors hover:text-primary">Why iTech</a>
            <a href="tel:+919876543210" className="transition-colors hover:text-primary">Contact</a>
          </div>
