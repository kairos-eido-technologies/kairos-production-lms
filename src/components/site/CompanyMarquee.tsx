...
export function LogoAWS({ h = 28 }: { h?: number }) {
  return (
    <svg height={h} viewBox="0 0 76 28" fill="none" className="w-auto block" xmlns="http://www.w3.org/2000/svg">
      <text
        x="38"
        y="16"
        textAnchor="middle"
...
export function LogoMicrosoft({ h = 28 }: { h?: number }) {
  return (
    <svg height={h} viewBox="0 0 120 28" fill="none" className="w-auto block" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="28" y="19" fontFamily="'Segoe UI', Arial, sans-serif" fontSize="16" fontWeight="600" fill="currentColor" letterSpacing="-0.2">Microsoft</text>
    </svg>
  );
}
...
export function LogoCisco({ h = 28 }: { h?: number }) {
  return (
    <svg height={h} viewBox="0 0 85 28" fill="none" className="w-auto block" xmlns="http://www.w3.org/2000/svg">
      <g fill="#00BCEB">
      ...
      <text x="42" y="26" textAnchor="middle" fontFamily="'Arial Black', Arial, sans-serif" fontSize="13" fontWeight="900" fill="#00BCEB" letterSpacing="1.8">CISCO</text>
    </svg>
  );
}
...
export function LogoCompTIA({ h = 28 }: { h?: number }) {
  return (
    <svg height={h} viewBox="0 0 118 28" fill="none" className="w-auto block" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="27" y="19" fontFamily="Arial, sans-serif" fontSize="15" fontWeight="800" fill="currentColor" letterSpacing="0.3">CompTIA</text>
    </svg>
  );
}
...
export function LogoOracle({ h = 28 }: { h?: number }) {
  return (
    <svg height={h} viewBox="0 0 105 28" fill="none" className="w-auto block" xmlns="http://www.w3.org/2000/svg">
      <path d="M11 5H3.2C1.4 5 0 6.4 0 8.2v11.6C0 21.6 1.4 23 3.2 23H11c1.8 0 3.2-1.4 3.2-3.2V8.2C14.2 6.4 12.8 5 11 5zm0 14H3.2V9H11v10z" fill="#F80000"/>
      <text x="21" y="19" fontFamily="'Arial Black', Arial, sans-serif" fontSize="15" fontWeight="900" fill="#F80000" letterSpacing="1">ORACLE</text>
    </svg>
  );
}
...
export function LogoRedHat({ h = 28 }: { h?: number }) {
  return (
    <svg height={h} viewBox="0 0 112 28" fill="none" className="w-auto block" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="32" y="19" fontFamily="Arial, sans-serif" fontSize="15" fontWeight="800" fill="currentColor" letterSpacing="0.3">Red Hat</text>
    </svg>
  );
}
...
export function LogoPaloAlto({ h = 28 }: { h?: number }) {
  return (
    <svg height={h} viewBox="0 0 125 28" fill="none" className="w-auto block" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="22" y="19" fontFamily="Arial, sans-serif" fontSize="14" fontWeight="800" fill="currentColor" letterSpacing="0.2">paloalto</text>
    </svg>
  );
}
...
export function LogoFortinet({ h = 28 }: { h?: number }) {
  return (
    <svg height={h} viewBox="0 0 120 28" fill="none" className="w-auto block" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="24" y="20" fontFamily="'Arial Black', Arial, sans-serif" fontSize="15" fontWeight="900" fill="currentColor" letterSpacing="0.5">FORTINET</text>
    </svg>
  );
}
...
export function LogoPearsonVUE({ h = 28 }: { h?: number }) {
  return (
    <svg height={h} viewBox="0 0 140 28" fill="none" className="w-auto block" xmlns="http://www.w3.org/2000/svg">
      <rect x="0" y="2" width="24" height="24" rx="5" fill="#005A8B"/>
      <text x="5" y="21" fontFamily="Georgia, serif" fontSize="18" fontWeight="900" fill="white">P</text>
      <text x="32" y="19" fontFamily="Arial, sans-serif" fontSize="14" fontWeight="700" fill="currentColor" letterSpacing="0.2">Pearson</text>
      <text x="94" y="19" fontFamily="'Arial Black', Arial, sans-serif" fontSize="14" fontWeight="900" fill="#005A8B" letterSpacing="0.5">VUE</text>
    </svg>
  );
}
...
export function CompanyMarquee() {
  return (
    <section aria-label="Certification Partners" className="relative w-full overflow-hidden py-10 bg-card/20 border-y border-border/40 backdrop-blur-sm">
