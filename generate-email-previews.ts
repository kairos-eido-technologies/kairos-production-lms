...
const templates = [
  ...
  },
  {
    ...
    html: `<!DOCTYPE html><html><head><meta charset="utf-8"><title>New Message — iTech Academy</title><style>${commonStyles}</style></head><body><div class="container"><div class="header"><div class="logo-badge">iT</div><div class="logo-text">iTech Academy</div><div class="company-sub">Kairos Eido Technologies</div></div><div class="content"><span class="badge">Inbox Notification</span><h1>New Message Received</h1><p>Hello Rhemanth Jeyanez,</p><p>You have received a new direct message from <strong>Dr. Sarah Jenkins</strong>:</p><div class="card"><div class="card-title">Office Hours Schedule Update</div><p style="color: #ffffff; font-style: italic; margin-top: 8px; margin-bottom: 0; line-height: 1.6;">"Hi Rhemanth, tomorrow's office hours have been moved to 3 PM EST. See you in the portal!"</p></div><div class="btn-container"><a href="https://kairos-production-lms.vercel.app/login" class="btn">Reply in Portal</a></div></div><div class="footer">&copy; 2026 Kairos Eido Technologies. All rights reserved.</div></div></body></html>`
  },
  {
    filename: "12-course-announcement.html",
    title: "12. Course Announcement Broadcast",
    html: `<!DOCTYPE html><html><head><meta charset="utf-8"><title>New Announcement — iTech Academy</title><style>${commonStyles}</style></head><body><div class="container"><div class="header"><div class="logo-badge">iT</div><div class="logo-text">iTech Academy</div><div class="company-sub">Kairos Eido Technologies</div></div><div class="content"><span class="badge">Broadcast Alert</span><h1>New Course Announcement</h1><p>Hello Rhemanth Jeyanez,</p><p>An announcement has been published in <strong>Full-Stack Web Development Mastery</strong>:</p><div class="card"><div class="card-title">New Lecture & Code Repository Added</div><p style="color: #ffffff; margin-top: 8px; margin-bottom: 0; line-height: 1.6;">Check out Section 5 for the latest code samples and video walkthroughs. Happy coding!</p></div><div class="btn-container"><a href="https://kairos-production-lms.vercel.app/login" class="btn">View Announcement</a></div></div><div class="footer">&copy; 2026 Kairos Eido Technologies. All rights reserved.</div></div></body></html>`
  },
  {
...
for (const t of templates) {
  ...
  console.log(`✨ Ultra-Premium Template Generated: ${t.filename}`);
}

console.log(`\n🎉 All 13 Ultra-Professional Email Templates generated in: ${outDir}`);
